...
#include "/home/stephen/dev/vendor/libsodium/src/libsodium/crypto_sign/ed25519/ref10/sign_ed25519_ref10.h"
#include "/home/stephen/dev/vendor/libsodium/src/libsodium/include/sodium/private/ed25519_ref10.h"
// #include <sodium/sign_ed25519_ref10.h>
...
namespace llarp
{
  namespace sodium
  {
    ...
    /// modified version of libsodium's _crypto_sign_ed25519_detached function which takes
    /// an explicit scalar + upper 32 bytes of hash as opposed to deriving this from seed
    static bool
    sign_with_subkey(unsigned char *sig, unsigned long long *siglen_p,
                              const unsigned char *m, unsigned long long mlen,
                              const unsigned char *scalar, const unsigned char *rh)
    {
      ...
      // copy and clamp our private scalar
      memcpy(a, scalar, 32);
      clamp_ed25519(a);

      crypto_hash_sha512_init(&hs);
      crypto_hash_sha512_update(&hs, rh, 32);
      ...
      sc25519_reduce(hram);
      sc25519_muladd(sig + 32, hram, scalar, nonce);
    ...
    bool
    CryptoLibSodium::sign(Signature &sig, const SubSecretKey &subkey, const llarp_buffer_t &msg)
    {
      /*
      return sign_with_subkey(sig.data(), sig.size(),
                              msg.base(), (msg.end() - msg.begin()),
                              subkey.GetScalar().data(), subkey.GetRandomValue())
          != 1;
          */
      (void)sig;
      (void)subkey;
